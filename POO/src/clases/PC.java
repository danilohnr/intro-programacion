...
public class PC {
	...
	//Debemos especificarle atributos (estados) y comportamientos (métodos)
	...
	public void establecerMarca(String marca) {
		...
		//marca es la variable local que es pasada como parámetro al método
		//this.marca = marca;
		//también podemos realizar validaciones de los parámetros
