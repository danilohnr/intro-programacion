...
public class Clases {
	//Todo objeto del mundo real tiene 2 características principales:
	//Estados y Comportamientos
	//Por ejemplo una PC, puede tener:
	//RAM, sistema operativo, Disco duro, tamaño del monitor, etc
	...
	public static void main(String[] args) {		
		...
		System.out.println("Año: " + auto1.mostrarAnio());
		...
		//auto1.propietario = "Danilo"; //Es legal pero no recomendable
		System.out.println("Propietario: " + auto1.propietario);*/
		//***********************************************************************
		Cuenta CuentaDanilo = new Cuenta();
		CuentaDanilo.setNombreCliente("Danilo Noguera");
		CuentaDanilo.setEmail("danilo.noguera@gmail.com");
		CuentaDanilo.setNumeroTelefono("88037049");
		CuentaDanilo.setNumero("1002033258121");
		CuentaDanilo.setBalance(0.00);
		
		CuentaDanilo.retirar(100.00);
		CuentaDanilo.depositar(50.00);
		CuentaDanilo.retirar(100.00);
		CuentaDanilo.depositar(51.00);
		CuentaDanilo.retirar(100.00);
